...
namespace ChildCareSystem.Migrations
{
    ...
    [Migration("20211020154111_UpdateDatabase2")]
            ...
            modelBuilder.Entity("ChildCareSystem.Models.Reservation", b =>
                {
                    ...
                    b.Property<int>("TimeAvailableId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChildCareSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("ChildCareSystem.Models.TimeAvailable", "TimeAvailable")
                        .WithMany()
                        .HasForeignKey("TimeAvailableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
